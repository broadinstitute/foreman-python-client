...
api_instance = pyforeman.ProductsApi()
id = 8.14 # float | product numeric identifier
...
# create an instance of the API class
api_instance = pyforeman.ProductsApi()
activation_key_id = 8.14 # float |
organization_id = 8.14 # float | Filter products by organization
subscription_id = 8.14 # float | Filter products by subscription
sync_plan_id = 8.14 # float | Filter products by sync plan id
...
gpg_key_id = 8.14 # float | Identifier of the GPG key (optional)
ssl_ca_cert_id = 8.14 # float | Idenifier of the SSL CA Cert (optional)
ssl_client_cert_id = 8.14 # float | Identifier of the SSL Client Cert (optional)
ssl_client_key_id = 8.14 # float | Identifier of the SSL Client Key (optional)
sync_plan_id = 8.14 # float | Plan numeric identifier (optional)
