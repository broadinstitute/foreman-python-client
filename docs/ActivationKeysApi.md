...
api_instance = pyforeman.ActivationKeysApi()
...
environment_id = 8.14 # float | environment identifier
...
environment_id = 8.14 # float | environment id (optional)
content_view_id = 8.14 # float | content view id (optional)
max_hosts = 8.14 # float | maximum number of registered content hosts (optional)
...
api_instance = pyforeman.ActivationKeysApi()
id = 8.14 # float | ID of the activation key
subscription_id = 8.14 # float | Subscription identifier (optional)
quantity = 8.14 # float | Quantity of this subscription to add (optional)
