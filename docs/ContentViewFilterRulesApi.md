# pyforeman.ContentViewFilterRulesApi
...
api_instance = pyforeman.ContentViewFilterRulesApi()
content_view_filter_id = 8.14 # float | filter identifier
id = 8.14 # float | rule identifier
