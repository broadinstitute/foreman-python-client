...
class SettingsApi(object):
    ...
    def get_settings_id(self, id, **kwargs):  # noqa: E501
        """Show a setting  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_settings_id(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_settings_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_settings_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_settings_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Show a setting  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_settings_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `id` when calling `get_settings_id`"
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type="SettingParams",  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get("async_req"),
            _return_http_data_only=params.get("_return_http_data_only"),
            _preload_content=params.get("_preload_content", True),
    ...
    def put_settings_id(self, id, **kwargs):  # noqa: E501
        """Update a setting  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_settings_id(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.put_settings_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.put_settings_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def put_settings_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update a setting  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_settings_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `id` when calling `put_settings_id`"
            )  # noqa: E501
        ...
        if "setting_value" in params:
            form_params.append(
                ("setting[value]", params["setting_value"])
            )  # noqa: E501
