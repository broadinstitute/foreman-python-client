...
class AuditsApi(object):
    ...
    def get_audits_id(self, id, **kwargs):  # noqa: E501
        """Show an audit  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_audits_id(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_audits_id_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_audits_id_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_audits_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Show an audit  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_audits_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `id` when calling `get_audits_id`"
            )  # noqa: E501
    ...
    def get_hosts_host_id_audits(self, host_id, **kwargs):  # noqa: E501
        """List all audits for a given host  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_hosts_host_id_audits(host_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_hosts_host_id_audits_with_http_info(
                host_id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_hosts_host_id_audits_with_http_info(
                host_id, **kwargs
            )  # noqa: E501
            return data

    def get_hosts_host_id_audits_with_http_info(self, host_id, **kwargs):  # noqa: E501
        """List all audits for a given host  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_hosts_host_id_audits_with_http_info(host_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_hosts_host_id_audits" % key
                )
            params[key] = val
        del params["kwargs"]
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `host_id` when calling `get_hosts_host_id_audits`"
            )  # noqa: E501
