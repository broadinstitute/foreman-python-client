...
class ModelsApi:
    ...
    def delete_models_id(
        ...
        _param = self._delete_models_id_serialize(
            id=id,
    ...
    @validate_call
    def delete_models_id_with_http_info(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    @validate_call
    def delete_models_id_without_preload_content(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    def _delete_models_id_serialize(
        self,
        id,
        location_id,
        organization_id,
    ...
    def get_models_id(
        ...
        _param = self._get_models_id_serialize(
            id=id,
            location_id=location_id,
            organization_id=organization_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_models_id_with_http_info(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    @validate_call
    def get_models_id_without_preload_content(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    def post_models(
        ...
        model_info: Optional[StrictStr] = None,
        model_vendor_class: Optional[StrictStr] = None,
        model_hardware_model: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param model_info:
        :type model_info: str
        :param model_vendor_class:
        :type model_vendor_class: str
        :param model_hardware_model:
        :type model_hardware_model: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_models_serialize(
            ...
            model_vendor_class=model_vendor_class,
            model_hardware_model=model_hardware_model,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    def _post_models_serialize(
        ...
        if model_name is not None:
            _form_params.append(("model[name]", model_name))
        if location_id is not None:
            _form_params.append(("location_id", location_id))
        if organization_id is not None:
            _form_params.append(("organization_id", organization_id))
        if model_info is not None:
            _form_params.append(("model[info]", model_info))
        if model_vendor_class is not None:
            _form_params.append(("model[vendor_class]", model_vendor_class))
        if model_hardware_model is not None:
            _form_params.append(("model[hardware_model]", model_hardware_model))
        # process the body parameter
    ...
    def put_models_id(
        ...
        _param = self._put_models_id_serialize(
            id=id,
            location_id=location_id,
            organization_id=organization_id,
            model_name=model_name,
    ...
    @validate_call
    def put_models_id_with_http_info(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    @validate_call
    def put_models_id_without_preload_content(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
