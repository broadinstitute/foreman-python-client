...
class RolesApi:
    ...
    @validate_call
    def delete_roles_id_with_http_info(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    @validate_call
    def delete_roles_id_without_preload_content(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    @validate_call
    def get_roles_id_with_http_info(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    @validate_call
    def get_roles_id_without_preload_content(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    def post_roles(
        ...
        role_description: Annotated[
            Optional[StrictStr], Field(description="Role description")
        ] = None,
        role_location_ids: Annotated[
            Optional[List[StrictStr]],
            Field(description="REPLACE locations with given ids"),
        ] = None,
        role_organization_ids: Annotated[
            Optional[List[StrictStr]],
        ...
        :param role_location_ids: REPLACE locations with given ids
        :type role_location_ids: List[str]
        :param role_organization_ids: REPLACE organizations with given ids.
        :type role_organization_ids: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_roles_serialize(
            ...
            role_location_ids=role_location_ids,
            role_organization_ids=role_organization_ids,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def post_roles_without_preload_content(
        self,
        role_name: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    def _post_roles_serialize(
        ...
        _collection_formats: Dict[str, str] = {
            "role[location_ids]": "csv",
            "role[organization_ids]": "csv",
        }
        ...
        if role_name is not None:
            _form_params.append(("role[name]", role_name))
        if location_id is not None:
            _form_params.append(("location_id", location_id))
        if organization_id is not None:
            _form_params.append(("organization_id", organization_id))
        if role_description is not None:
            _form_params.append(("role[description]", role_description))
        if role_location_ids is not None:
            _form_params.append(("role[location_ids]", role_location_ids))
        if role_organization_ids is not None:
            _form_params.append(("role[organization_ids]", role_organization_ids))
        # process the body parameter
    ...
    def post_roles_id_clone(
        ...
        _param = self._post_roles_id_clone_serialize(
            id=id,
            location_id=location_id,
            organization_id=organization_id,
            role_name=role_name,
    ...
    @validate_call
    def post_roles_id_clone_with_http_info(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    @validate_call
    def post_roles_id_clone_without_preload_content(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    def _post_roles_id_clone_serialize(
        self,
        id,
        location_id,
        organization_id,
    ...
    def put_roles_id(
        ...
        _param = self._put_roles_id_serialize(
            id=id,
            location_id=location_id,
            organization_id=organization_id,
            role_name=role_name,
    ...
    @validate_call
    def put_roles_id_with_http_info(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    @validate_call
    def put_roles_id_without_preload_content(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
