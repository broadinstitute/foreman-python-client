...
class OsDefaultTemplatesApi:
    ...
    def delete_operatingsystems_operatingsystem_id_os_default_templates_id(
        ...
        _param = self._delete_operatingsystems_operatingsystem_id_os_default_templates_id_serialize(
    ...
    @validate_call
    def delete_operatingsystems_operatingsystem_id_os_default_templates_id_without_preload_content(
        self,
        operatingsystem_id: Annotated[
            Union[StrictFloat, StrictInt], Field(description="ID of operating system")
        ],
    ...
    def _delete_operatingsystems_operatingsystem_id_os_default_templates_id_serialize(
        self,
        operatingsystem_id,
        id,
        location_id,
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/operatingsystems/{operatingsystem_id}/os_default_templates/{id}",
    ...
    def get_operatingsystems_operatingsystem_id_os_default_templates(
        ...
        provisioning_template_id: Annotated[
            StrictStr, Field(description="ID of provisioning template")
        ],
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
            Field(description="Set the current location context for the request"),
        ...
        :param operatingsystem_id: ID of operating system (required)
        :type operatingsystem_id: float
        :param provisioning_template_id: ID of provisioning template (required)
        ...
        _param = self._get_operatingsystems_operatingsystem_id_os_default_templates_serialize(
            operatingsystem_id=operatingsystem_id,
    ...
    @validate_call
    def get_operatingsystems_operatingsystem_id_os_default_templates_without_preload_content(
        self,
        operatingsystem_id: Annotated[
            Union[StrictFloat, StrictInt], Field(description="ID of operating system")
        ],
    ...
    def _get_operatingsystems_operatingsystem_id_os_default_templates_serialize(
        self,
        operatingsystem_id,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/operatingsystems/{operatingsystem_id}/os_default_templates",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_operatingsystems_operatingsystem_id_os_default_templates_id(
        ...
        _param = self._get_operatingsystems_operatingsystem_id_os_default_templates_id_serialize(
            operatingsystem_id=operatingsystem_id,
            id=id,
            location_id=location_id,
            organization_id=organization_id,
    ...
    @validate_call
    def get_operatingsystems_operatingsystem_id_os_default_templates_id_without_preload_content(
        self,
        operatingsystem_id: Annotated[
            Union[StrictFloat, StrictInt], Field(description="ID of operating system")
        ],
    ...
    def _get_operatingsystems_operatingsystem_id_os_default_templates_id_serialize(
        self,
        operatingsystem_id,
        id,
        location_id,
    ...
    def get_provisioning_templates_provisioning_template_id_os_default_templates(
        ...
        _param = self._get_provisioning_templates_provisioning_template_id_os_default_templates_serialize(
            provisioning_template_id=provisioning_template_id,
            operatingsystem_id=operatingsystem_id,
            location_id=location_id,
            organization_id=organization_id,
    ...
    @validate_call
    def get_provisioning_templates_provisioning_template_id_os_default_templates_without_preload_content(
        self,
        provisioning_template_id: Annotated[
            StrictStr, Field(description="ID of provisioning template")
        ],
    ...
    def _get_provisioning_templates_provisioning_template_id_os_default_templates_serialize(
        self,
        provisioning_template_id,
        operatingsystem_id,
        location_id,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/provisioning_templates/{provisioning_template_id}/os_default_templates",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def post_operatingsystems_operatingsystem_id_os_default_templates(
        ...
        os_default_template_template_kind_id: Optional[
            Union[StrictFloat, StrictInt]
        ] = None,
        os_default_template_provisioning_template_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
            Field(description="ID of provisioning template"),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param organization_id: Set the current organization context for the request
        :type organization_id: float
        :param os_default_template_template_kind_id:
        :type os_default_template_template_kind_id: float
        :param os_default_template_provisioning_template_id: ID of provisioning template
        :type os_default_template_provisioning_template_id: float
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_operatingsystems_operatingsystem_id_os_default_templates_serialize(
            operatingsystem_id=operatingsystem_id,
            location_id=location_id,
            organization_id=organization_id,
            os_default_template_template_kind_id=os_default_template_template_kind_id,
            os_default_template_provisioning_template_id=os_default_template_provisioning_template_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def post_operatingsystems_operatingsystem_id_os_default_templates_without_preload_content(
        self,
        operatingsystem_id: Annotated[
            Union[StrictFloat, StrictInt], Field(description="ID of operating system")
        ],
    ...
    def _post_operatingsystems_operatingsystem_id_os_default_templates_serialize(
        self,
        operatingsystem_id,
        location_id,
        organization_id,
        ...
        if organization_id is not None:
            _form_params.append(("organization_id", organization_id))
        if os_default_template_template_kind_id is not None:
            _form_params.append(
                (
        ...
        if os_default_template_provisioning_template_id is not None:
            _form_params.append(
                (
    ...
    def put_operatingsystems_operatingsystem_id_os_default_templates_id(
        ...
        _param = self._put_operatingsystems_operatingsystem_id_os_default_templates_id_serialize(
            operatingsystem_id=operatingsystem_id,
            id=id,
            location_id=location_id,
            organization_id=organization_id,
    ...
    @validate_call
    def put_operatingsystems_operatingsystem_id_os_default_templates_id_without_preload_content(
        self,
        operatingsystem_id: Annotated[
            Union[StrictFloat, StrictInt], Field(description="ID of operating system")
        ],
    ...
    def _put_operatingsystems_operatingsystem_id_os_default_templates_id_serialize(
        self,
        operatingsystem_id,
        id,
        location_id,
