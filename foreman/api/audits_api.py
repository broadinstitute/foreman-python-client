...
class AuditsApi:
    ...
    def get_audits_id(
        ...
        _param = self._get_audits_id_serialize(
            id=id,
            location_id=location_id,
            organization_id=organization_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_audits_id_with_http_info(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    @validate_call
    def get_audits_id_without_preload_content(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    def get_hosts_host_id_audits(
        ...
        _param = self._get_hosts_host_id_audits_serialize(
            host_id=host_id,
            location_id=location_id,
            organization_id=organization_id,
            search=search,
    ...
    @validate_call
    def get_hosts_host_id_audits_with_http_info(
        self,
        host_id: Union[StrictFloat, StrictInt],
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    @validate_call
    def get_hosts_host_id_audits_without_preload_content(
        self,
        host_id: Union[StrictFloat, StrictInt],
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    def _get_hosts_host_id_audits_serialize(
        self,
        host_id,
        location_id,
        organization_id,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/hosts/{host_id}/audits",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
