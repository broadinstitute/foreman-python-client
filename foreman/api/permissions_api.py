...
class PermissionsApi:
    ...
    def get_permissions_id(
        ...
        _param = self._get_permissions_id_serialize(
            id=id,
            location_id=location_id,
            organization_id=organization_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_permissions_id_with_http_info(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    @validate_call
    def get_permissions_id_without_preload_content(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    def _get_permissions_id_serialize(
        self,
        id,
        location_id,
        organization_id,
    ...
    @validate_call
    def get_permissions_resource_types(
        self,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
            Field(description="Set the current location context for the request"),
        ...
        _param = self._get_permissions_resource_types_serialize(
            location_id=location_id,
            organization_id=organization_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_permissions_resource_types_with_http_info(
        self,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
            Field(description="Set the current location context for the request"),
    ...
    @validate_call
    def get_permissions_resource_types_without_preload_content(
        self,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
            Field(description="Set the current location context for the request"),
    ...
    def _get_permissions_resource_types_serialize(
        self,
        location_id,
        organization_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/permissions/resource_types",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
