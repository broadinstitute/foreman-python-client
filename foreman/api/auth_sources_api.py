...
class AuthSourcesApi:
    ...
    def get_auth_sources(
        ...
        _param = self._get_auth_sources_serialize(
    ...
    @validate_call
    def get_auth_sources_without_preload_content(
        self,
        location_id: Annotated[
            Union[StrictFloat, StrictInt], Field(description="Scope by locations")
        ],
    ...
    def _get_auth_sources_serialize(
        self,
        location_id,
        organization_id,
        search,
    ...
    def get_locations_location_id_auth_sources(
        ...
        _param = self._get_locations_location_id_auth_sources_serialize(
            location_id=location_id,
            organization_id=organization_id,
            search=search,
            order=order,
    ...
    @validate_call
    def get_locations_location_id_auth_sources_without_preload_content(
        self,
        location_id: Annotated[
            Union[StrictFloat, StrictInt], Field(description="Scope by locations")
        ],
    ...
    def _get_locations_location_id_auth_sources_serialize(
        self,
        location_id,
        organization_id,
        search,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/locations/{location_id}/auth_sources",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_organizations_organization_id_auth_sources(
        ...
        _param = self._get_organizations_organization_id_auth_sources_serialize(
            organization_id=organization_id,
            location_id=location_id,
            search=search,
            order=order,
    ...
    @validate_call
    def get_organizations_organization_id_auth_sources_without_preload_content(
        self,
        organization_id: Annotated[
            Union[StrictFloat, StrictInt], Field(description="Scope by organizations")
        ],
    ...
    def _get_organizations_organization_id_auth_sources_serialize(
        self,
        organization_id,
        location_id,
        search,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/organizations/{organization_id}/auth_sources",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
