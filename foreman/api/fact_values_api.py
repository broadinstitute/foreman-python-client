...
class FactValuesApi:
    ...
    def get_fact_values(
        ...
        _param = self._get_fact_values_serialize(
    ...
    @validate_call
    def get_fact_values_with_http_info(
        self,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
            Field(description="Set the current location context for the request"),
    ...
    @validate_call
    def get_fact_values_without_preload_content(
        self,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
            Field(description="Set the current location context for the request"),
    ...
    def _get_fact_values_serialize(
        self,
        location_id,
        organization_id,
        search,
    ...
    def get_hosts_host_id_facts(
        ...
        _param = self._get_hosts_host_id_facts_serialize(
            host_id=host_id,
            location_id=location_id,
            organization_id=organization_id,
            search=search,
    ...
    @validate_call
    def get_hosts_host_id_facts_with_http_info(
        self,
        host_id: Union[StrictFloat, StrictInt],
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    @validate_call
    def get_hosts_host_id_facts_without_preload_content(
        self,
        host_id: Union[StrictFloat, StrictInt],
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    def _get_hosts_host_id_facts_serialize(
        self,
        host_id,
        location_id,
        organization_id,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/hosts/{host_id}/facts",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
