...
class TemplateInvocationsApi:
    ...
    def get_job_invocations_job_invocation_id_template_invocations(
        ...
        :param job_invocation_id: (required)
        ...
        _param = (
            self._get_job_invocations_job_invocation_id_template_invocations_serialize(
    ...
    @validate_call
    def get_job_invocations_job_invocation_id_template_invocations_without_preload_content(
        self,
        job_invocation_id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    def _get_job_invocations_job_invocation_id_template_invocations_serialize(
        self,
        job_invocation_id,
        location_id,
        organization_id,
        ...
        if job_invocation_id is not None:
            _path_params["job_invocation_id"] = job_invocation_id
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/job_invocations/{job_invocation_id}/template_invocations",
