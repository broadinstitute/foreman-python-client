...
class AuthSourceInternalsApi:
    ...
    def get_auth_source_internals(
        ...
        _param = self._get_auth_source_internals_serialize(
    ...
    @validate_call
    def get_auth_source_internals_with_http_info(
        self,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
            Field(description="Set the current location context for the request"),
    ...
    @validate_call
    def get_auth_source_internals_without_preload_content(
        self,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
            Field(description="Set the current location context for the request"),
    ...
    def _get_auth_source_internals_serialize(
        self,
        location_id,
        organization_id,
        search,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/auth_source_internals",
    ...
    @validate_call
    def get_auth_source_internals_id(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
        ...
        _param = self._get_auth_source_internals_id_serialize(
            id=id,
            location_id=location_id,
            organization_id=organization_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_auth_source_internals_id_with_http_info(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    @validate_call
    def get_auth_source_internals_id_without_preload_content(
        self,
        id: StrictStr,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
    ...
    def _get_auth_source_internals_id_serialize(
        self,
        id,
        location_id,
        organization_id,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/auth_source_internals/{id}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
