...
class HostDebsApi:
    ...
    def get_hosts_host_id_debs(
        ...
        _param = self._get_hosts_host_id_debs_serialize(
            host_id=host_id,
            search=search,
            page=page,
            per_page=per_page,
    ...
    @validate_call
    def get_hosts_host_id_debs_with_http_info(
        self,
        host_id: Annotated[
            Union[StrictFloat, StrictInt], Field(description="ID of the host")
        ],
    ...
    @validate_call
    def get_hosts_host_id_debs_without_preload_content(
        self,
        host_id: Annotated[
            Union[StrictFloat, StrictInt], Field(description="ID of the host")
        ],
    ...
    def _get_hosts_host_id_debs_serialize(
        self,
        host_id,
        search,
        page,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/hosts/{host_id}/debs",
