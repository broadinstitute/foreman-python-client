...
class HostStatusesApi:
    ...
    def get_host_statuses(
        ...
        _param = self._get_host_statuses_serialize(
    ...
    @validate_call
    def get_host_statuses_with_http_info(
        self,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
            Field(description="Set the current location context for the request"),
    ...
    @validate_call
    def get_host_statuses_without_preload_content(
        self,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
            Field(description="Set the current location context for the request"),
    ...
    def _get_host_statuses_serialize(
        self,
        location_id,
        organization_id,
        page,
