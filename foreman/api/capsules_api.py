...
class CapsulesApi:
    ...
    def get_capsules(
        ...
        _param = self._get_capsules_serialize(
            search=search,
            page=page,
            per_page=per_page,
            order=order,
    ...
    @validate_call
    def get_capsules_without_preload_content(
        self,
        search: Annotated[
            Optional[StrictStr], Field(description="Search string")
        ] = None,
    ...
    def get_capsules_id(
        ...
        _param = self._get_capsules_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_capsules_id_with_http_info(
        self,
        id: Annotated[
            Union[StrictFloat, StrictInt], Field(description="Id of the smart proxy")
        ],
    ...
    @validate_call
    def get_capsules_id_without_preload_content(
        self,
        id: Annotated[
            Union[StrictFloat, StrictInt], Field(description="Id of the smart proxy")
        ],
    ...
    def _get_capsules_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
