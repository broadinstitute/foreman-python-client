...
class TemplateKindsApi:
    ...
    def get_template_kinds(
        ...
        _param = self._get_template_kinds_serialize(
    ...
    @validate_call
    def get_template_kinds_with_http_info(
        self,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
            Field(description="Set the current location context for the request"),
    ...
    @validate_call
    def get_template_kinds_without_preload_content(
        self,
        location_id: Annotated[
            Optional[Union[StrictFloat, StrictInt]],
            Field(description="Set the current location context for the request"),
    ...
    def _get_template_kinds_serialize(
        self,
        location_id,
        organization_id,
        search,
